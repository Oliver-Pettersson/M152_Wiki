...
export default function Card({title, image}: PropsType) {
  return (
    <div className="py-4 w-60">
      <div className={"shadow-lg group container  rounded-md bg-white  max-w-sm flex justify-center items-center  mx-auto content-div bg-[url('" + location.protocol + "//" + location.host + image +"')]"}>
