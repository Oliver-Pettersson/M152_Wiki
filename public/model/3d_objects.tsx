...
export const Model = (props: any) => {
    const {nodes, materials} = useSpline('https://prod.spline.design/iMwsnyvOBGO7Cg7R/scene.splinecode')
    return (
        <>
            <color attach="background" args={['#e56ea2']}/>
            <group {...props} dispose={null}>
                ...
                <group name="Lifebuoy" position={[368.86, -246.68, -203.91]} rotation={[-0.15, -0.44, -0.77]}
                       scale={0.9}>
                    <mesh
                        name="Torus 8"
                ...
                <group name="Discount" position={[-21.07, -169.97, -54.63]} rotation={[0, 0, 0.26]} scale={0.96}>
                    <group name="Group 26" position={[-3.72, 0, -16.4]} rotation={[0.09, 0, -Math.PI / 9]} scale={1}>
                        <mesh
                            name="%"
                    ...
                    <group name="Group 25" position={[20.39, -1.29, 10.58]} rotation={[-0.17, -0.02, 0.08]} scale={1}>
                        <mesh
                            name="Ellipse 21"
                ...
                <group name="calculator" position={[434.17, -72.63, 131.85]} rotation={[-Math.PI / 4, 0.19, 0]}
                       scale={0.85}>
                    <mesh
                        name="Rectangle 71"
                ...
                <PerspectiveCamera
                    ...
                    near={5}
                    fov={45}
                    position={[55.33, 208.97, 1209.02]}
                    rotation={[-0.15, 0.04, 0.01]}
                    scale={1}
                />
